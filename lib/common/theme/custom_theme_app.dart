...
import 'package:state_manage_todo_app/common/data/preference/prefs.dart';
import 'package:state_manage_todo_app/common/theme/custom_theme.dart';
...
class _CustomThemeAppState extends State<CustomThemeApp> {
  ...
  final CustomTheme? defaultTheme = CustomTheme.light;
   ...
   handleChangeTheme(CustomTheme theme) {
